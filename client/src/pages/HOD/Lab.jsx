...
import Request from '../../components/Request_Modal3.jsx'
...
function Lab() {
    ...
    const search = async () => {
        ...
        label.classList.add("label")
            ...
            try {
                const data = { User_Id:userId,Building_Name,Weekdayy, Slot ,Belongs_To:department}
                const res = await axios.post(`http://localhost:3001/hodsearchlabs`, data);
                            ...
                            seminardata.map((object, i) =>
                                <div key={i}>
                                    <Request room={object.Lab_Name} capacity={object.Student_Capacity} computers={object.No_of_Computers} type={object.Type_} isOccupied={object.Occupied} 
                                        belongsTo={object.Belongs_To} occupiedBy={object.Branch_Occupied}  projector={object.Projector} isReleased={object.Released} internet={object.Internet} resource={resource}
